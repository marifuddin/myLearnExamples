...
public class TC_AdminCancelClass {
	...
	public void AdminCancelClass(){
		...
		{	
			...
			learningPage.FilterClassUsingDevtypSatus("Classroom Training", "Open - Normal");
			
			learningPage.CancelClass();
