...
public class  TC_ValidateAdminIsAbleToAddResourcesAndEquivalentToAClass {
	...
	@Test
	public void ValidateAdminIsAbleToAddResourcesAndEquivalentToAClass(){
		try
		{	
			...
			adminpage.searchManage_JobNameWithClassID("TEST_ZAK");

			adminpage.clickOnTheCatalogSearchActions("TEST-COURSE-PD-UAT");
