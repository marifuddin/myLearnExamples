...
public class MyLearnMainContent extends myutils{
	...
	public void saveNewClassRoomEvent(String language,String instance) throws InterruptedException
	{
		...
		case "LabConnect":
			...
			setTextField(date_end, "01/15/2017");
			break;
		case "WalkIn":
	...
	{
		String certificate_tbl_holder = "//td[contains(text(),'results')]/../../../tbody//td/div[text()='Expired']";
		List<WebElement> tbl_rows     = oASelFW.driver.findElements(By.xpath(certificate_tbl_holder));
		if(tbl_rows.size()>0)
		{
