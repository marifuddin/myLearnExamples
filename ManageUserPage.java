...
*/
	...
	*//*This method will verify the completed and Renewed Date Status in Training Plan Filter Area.
	...
	{
		System.out.println("Entered payment method");
	 ...
	 * @throws InterruptedException 
	 */
	public void setPaymentInformation(String paymethod,String CmpnyName, String Street, String City, String Country, String email, String Contact, String phone) throws InterruptedException
	{
		GiveMailingAddress( CmpnyName,  Street, City, Country, email, Contact, phone);
		System.out.println("Before Payment method");
	...
	public void GiveMailingAddress(String CmpnyName, String Street, String City, String Country, String email, String Contact, String phone)
	{
		String bill_org="//input[@name='bill_org']";
		String bill_Street="//input[@name='bill_street1']";
		String bill_city="//input[@name='bill_city']";
		String bill_country="//select[@name='bill_country']";
		String bill_contact="//input[@name='bill_contact']";
		String bill_email="//input[@name='bill_email']";
		String bill_phone="//input[@name='bill_phone']";
		setTextField(bill_org, CmpnyName);
		setTextField(bill_Street, Street);
		setTextField(bill_city, City);
		setTextField(bill_contact, Contact);
		cleartextField(bill_email);
		setTextField(bill_email, email);
		setTextField(bill_phone, phone);
		selectByVisibleText(bill_country, Country);
