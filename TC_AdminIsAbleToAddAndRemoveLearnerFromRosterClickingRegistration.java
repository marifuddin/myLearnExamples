...
public class TC_AdminIsAbleToAddAndRemoveLearnerFromRosterClickingRegistration {
	...
	@Test
	public void DropRegisteredLearnerAndVerifySeatAlottedToWaitlistedLearner(){
		try
		{	
			...
			adminpage.searchManage_JobNameWithClassID("VILT-PK-SABAMEETING");

			adminpage.clickOnTheCatalogSearchActions("Test-PD-Tuesday-VILT");
