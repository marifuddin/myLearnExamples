...
public class TC_ValidateDeliveryTypeIsAddedToACourse {
	...
	@Test
	public void ValidateDeliveryTypeIsAddedToACourse(){
		try
		{	
			...
			adminpage.verifyDeliveryTypesInManageClasses(BasedCourse);
