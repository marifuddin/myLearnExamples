...
public class TC_ValidateAssessmentAdminIsAbleCreateAssessmentWithIsScoringOptionEnabled {
	...
	@Test
	public void ValidateAssessmentAdminIsAbleCreateAssessmentWithIsScoringOptionEnabled(){
		try
		{	
			...
			String contentFolder  			= "myLearn Assessments";
			...
			oASelFW.effecta("verifyElementPresent","//span[text()='Is Scoring']","Is Scoring");	
