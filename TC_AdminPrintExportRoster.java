...
public class TC_AdminPrintExportRoster {
	...
	@Test
	public void AdminPrintExportRoster(){
		try
		{	
			...
			learningPage.FilterClassUsinDEvtypeStatusAndTitle("Classroom Training", "Open - Normal");
			
			learningPage.PrintExportFromRoster();
