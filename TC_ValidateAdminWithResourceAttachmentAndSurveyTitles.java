...
public class TC_ValidateAdminWithResourceAttachmentAndSurveyTitles {
	...
	@Test
	public void ValidateAdminWithResourceAttachmentAndSurveyTitles(){
		try
		{	
			...
			adminpage.searchManage_JobNameWithClassID("12345");

			adminpage.clickOnTheCatalogSearchActions("Certified Scrum Master");
			
			
			learningPage.validateOtherInformationForSurveyType("Allegiance");
			...
			oASelFW.effecta("verifyElementPresent","//a[text()='Test file']","Attachment Name");
