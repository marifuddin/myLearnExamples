...
public class TC_VerifyAdminIsAbleToAddContentToWBTOfferings {
	...
	@Test
	public void VerifyAdminIsAbleToAddContentToWBTOfferings(){
		try
		{
			...
			adminpage.searchManage_JobName("Test");
			
			adminpage.clickOnTheCatalogSearchActions("Test");
			
			learningPage.click_TabsHeadingInCourseDetailsPage(TabActivities);

			learningPage.validateActivitiesTabPageForActivities();
