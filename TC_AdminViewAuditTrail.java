...
public class TC_AdminViewAuditTrail {
	...
	@Test
	public void AdminCanRescheduleClass(){
		try
		{	
			...
			learningPage.FilterClassUsingDevtypDate("Classroom Training");
			
			learningPage.ClickOnAuditTrail("onClassPage");
