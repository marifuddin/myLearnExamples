...
public class TC_AdminIsAbleToAddAndRemoveLearnerFromRosterClickingRegistrationForWBT {
	...
	@Test
	public void AdminIsAbleToAddAndRemoveLearnerFromRosterClickingRegistrationForWBT(){
		try
		{	
			...
			String LearnerName		= "Arifuddin Mohd";
			...
			adminpage.searchManage_JobNameWithClassID("00003202");

			adminpage.clickOnTheCatalogSearchActions("01-vCloud Director 5.1 ICM - Metadelivery");

			learningPage.verifyRosterButton();

			learningPage.changeStatusOflearnerWithName("Drop this registration for these learners",LearnerName);


			learningPage.AddLearnerToAfterDeletion(list);
