...
public class TC_CreatingCertificationAndAddPathAddModuleAsMandatatoryAddCourses {
	...
	@Test
	public void CreatingCertificationAndAddPathAddModuleAsMandatatoryAddCourses(){
		try
		{	
				...
				String LearningPathCertification = oASelFW.getConstValFrmPropertyFile("LearningPathCertification");
				...
				String sSelectSQLJobFamily 		= "Select * from EndToEnd where bFlag='T' and sTestcaseId='TC_CreatingCertificationAndAddPathAddModuleAsMandatatoryAddCourses'";
				...
				System.out.println(NewLearningPath+"+++++++++++++++++"+LearningPathCertification);

				learningPage.newCatalogItemsPage(NewLearningPath, LearningPathCertification);
