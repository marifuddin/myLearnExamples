...
public class TC_VerifyLearnerAbleToViewCompletedLABOnCompletedLearningPage {
	...
	public void VerifyLearnerIsAbleToGetCertificateAfterCompletingCourse(){
		...
		{	
			...
			Thread.sleep(6000);
			oASelFW.effecta("verifyElementPresent","//span[contains(text(),'01-vCloud Director 5.1 ICM - Metadelivery')]","01-vCloud Director 5.1 ICM - Metadelivery");
