...
public class TC_ValidateILTOfferingDeliveryTypeInRelatedInfo_Attachmentpage {
	...
	@Test
	public void ValidateILTOfferingDeliveryTypeInRelatedInfo_Attachmentpage(){
		try
		{	
			...
			String TabActivities			= oASelFW.getConstValFrmPropertyFile("Tab_RelatedInfo");
